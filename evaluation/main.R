...
for (period in periods) {
  results <- evaluate(linton_dist, expectedCFR, period)
...
for (period in periods) {
  results <- evaluate(linton_dist, expectedCFR, period, minDailyCases=0, maxDailyCases=100)
